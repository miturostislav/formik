...
var Formik = (function (_super) {
    ...
    function Formik(props) {
        ...
        _this.executeFailedSubmit = function () {
            if (isFunction(_this.props.onFailSubmit)) {
                _this.props.onFailSubmit(_this.state.errors, _this.getFormikActions());
            }
        };
        ...
        return !!touch && !!error
            ? render
                ...
                : children
                    ...
                    : component
                        ? createElement(component, rest, error)
                        : error
            : null;
    };
